...
/**
 This collectionViewLayout will behave as a *CRSnapToCenterCollectionViewLayout* with the exception that it
 ...
 *CRSnapToCenterCollectionViewLayout* or a normal UICollectionViewFlowLayout if the snap to center was disabled.
 */
